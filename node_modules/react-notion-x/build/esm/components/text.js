            ...
            switch (decorator[0]) {
                ...
                case 'eoi': {
                    ...
                    switch ((_f = externalObjectInstance === null || externalObjectInstance === void 0 ? void 0 : externalObjectInstance.format) === null || _f === void 0 ? void 0 : _f.domain) {
                        case 'github.com':
                            return (React.createElement(ExternalComponentGithub, { original_url: (_g = externalObjectInstance.format) === null || _g === void 0 ? void 0 : _g.original_url, className: blockId }));
                        default:
