        ...
        if (data ||
            ...
            switch (schema.type) {
                ...
                case 'checkbox': {
                    ...
                    return (React.createElement("div", { className: 'notion-property-checkbox-container' },
                        React.createElement(Checkbox, { isChecked: isChecked, blockId: undefined }),
                        React.createElement("span", { className: 'notion-property-checkbox-text' }, schema.name)));
                }
                case 'url': {
