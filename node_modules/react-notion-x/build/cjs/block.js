    ...
    switch (block.type) {
        ...
        case 'page':
            if (level === 0) {
                    ...
                    return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion', 'notion-app', darkMode ? 'dark-mode' : 'light-mode', blockId, className) },
                        ...
                        react_1["default"].createElement("div", { className: 'notion-frame' },
                            ...
                            react_1["default"].createElement("div", { className: 'notion-page-scroller' },
                                hasPageCover ? (pageCover ? (pageCover) : (react_1["default"].createElement("div", { className: 'notion-page-cover-wrapper' },
                                    react_1["default"].createElement(lazy_image_1.LazyImage, { src: mapImageUrl(page_cover, block), alt: (0, notion_utils_1.getTextContent)(properties === null || properties === void 0 ? void 0 : properties.title), priority: true, className: 'notion-page-cover', style: {
                ...
                return (react_1["default"].createElement(components.pageLink, { className: (0, utils_1.cs)('notion-page-link', blockColor && "notion-" + blockColor, blockId), href: mapPageUrl(block.id) },
        ...
        case 'sub_sub_header': {
            ...
            var title = (0, notion_utils_1.getTextContent)(block.properties.title) || "Notion Header " + id;
            ...
            var classNameStr = (0, utils_1.cs)(isH1 && 'notion-h notion-h1', isH2 && 'notion-h notion-h2', isH3 && 'notion-h notion-h3', blockColor && "notion-" + blockColor, indentLevelClass, blockId);
            var innerHeader = (react_1["default"].createElement("span", null,
                ...
                !((_f = block.format) === null || _f === void 0 ? void 0 : _f.toggleable) && (react_1["default"].createElement("a", { className: 'notion-hash-link', href: "#" + id, title: title },
        ...
        case 'quote': {
            ...
            return (react_1["default"].createElement("blockquote", { className: (0, utils_1.cs)('notion-quote', blockColor && "notion-" + blockColor, blockId) },
                react_1["default"].createElement(text_1.Text, { value: block.properties.title, block: block })));
        }
        ...
        case 'table_of_contents': {
            ...
            return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-table-of-contents', blockColor && "notion-" + blockColor, blockId) }, toc.map(function (tocItem) { return (react_1["default"].createElement("a", { key: tocItem.id, href: "#" + (0, notion_utils_1.uuidToId)(tocItem.id), className: 'notion-table-of-contents-item' },
                react_1["default"].createElement("span", { className: 'notion-table-of-contents-item-body', style: {
                        display: 'inline-block',
        ...
        case 'external_object_instance':
            switch ((_17 = block.format) === null || _17 === void 0 ? void 0 : _17.domain) {
                case 'github.com':
                    return (react_1["default"].createElement(external_component_github_1.ExternalComponentGithub, { original_url: (_18 = block.format) === null || _18 === void 0 ? void 0 : _18.original_url, block: true, className: blockId }));
                default:
