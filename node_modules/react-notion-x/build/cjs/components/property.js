        ...
        if (data ||
            ...
            switch (schema.type) {
                ...
                case 'checkbox': {
                    ...
                    return (react_1["default"].createElement("div", { className: 'notion-property-checkbox-container' },
                        react_1["default"].createElement(checkbox_1.Checkbox, { isChecked: isChecked, blockId: undefined }),
                        react_1["default"].createElement("span", { className: 'notion-property-checkbox-text' }, schema.name)));
                }
                case 'url': {
