...
var Equation = function (_a) {
    ...
    var components = (0, context_1.useNotionContext)().components;
    return (react_1["default"].createElement("span", { role: 'button', tabIndex: 0, className: (0, utils_1.cs)('notion-equation', rest.block ? 'notion-equation-block' : 'notion-equation-inline', className) },
