...
var external_component_github_1 = require("./external-component-github");
/**
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null, value === null || value === void 0 ? void 0 : value.map(function (_a, index) {
        ...
        var formatted = decorations.reduce(function (element, decorator) {
            ...
            switch (decorator[0]) {
                ...
                case 'eoi': {
                    var blockId = decorator[1];
                    var externalObjectInstance = (_e = recordMap.block[blockId]) === null || _e === void 0 ? void 0 : _e.value;
                    switch ((_f = externalObjectInstance === null || externalObjectInstance === void 0 ? void 0 : externalObjectInstance.format) === null || _f === void 0 ? void 0 : _f.domain) {
                        case 'github.com':
                            return (react_1["default"].createElement(external_component_github_1.ExternalComponentGithub, { original_url: (_g = externalObjectInstance.format) === null || _g === void 0 ? void 0 : _g.original_url, className: blockId }));
                        default:
                            if (process.env.NODE_ENV !== 'production') {
                                console.log("Unsupported external_object_instance domain " + ((_h = externalObjectInstance === null || externalObjectInstance === void 0 ? void 0 : externalObjectInstance.format) === null || _h === void 0 ? void 0 : _h.domain) + ": " +
